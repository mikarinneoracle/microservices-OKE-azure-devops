...
ALTER TABLE "PRICE" MODIFY ("ID" NOT NULL ENABLE);
...
ALTER TABLE "PRICE" ADD CONSTRAINT "PRICE_CON_TIER_UNIQUE" UNIQUE ("TIER")
  USING INDEX  ENABLE;
...
ALTER TABLE "OPTIONS" MODIFY ("ID" NOT NULL ENABLE);

ALTER TABLE "OPTIONS" MODIFY ("TIER" NOT NULL ENABLE);

ALTER TABLE "OPTIONS" ADD CONSTRAINT "OPTIONS_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;

ALTER TABLE "OPTIONS" ADD CONSTRAINT "OPTIONS_FK" FOREIGN KEY ("TIER")
	  REFERENCES "PRICE" ("TIER") ENABLE;
