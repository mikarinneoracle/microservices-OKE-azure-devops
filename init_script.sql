...
INSERT INTO PRICE (TIER, PRICE_MO, USERS, STORAGE, SUPPORT) VALUES ('ENTERPRISE', 500, 1000, 50000, 'Phone and Email');

INSERT INTO OPTIONS (TIER, ISPUBLIC, ISPRIVATE, ISPERMISSIONS, ISSHARING, ISUNLIMITED, ISEXTRASEC) VALUES ('FREE', 'Y', 'N', 'Y', 'N', 'N', 'N');
INSERT INTO OPTIONS (TIER, ISPUBLIC, ISPRIVATE, ISPERMISSIONS, ISSHARING, ISUNLIMITED, ISEXTRASEC) VALUES ('PRO', 'Y', 'Y', 'Y', 'Y', 'Y', 'N');
INSERT INTO OPTIONS (TIER, ISPUBLIC, ISPRIVATE, ISPERMISSIONS, ISSHARING, ISUNLIMITED, ISEXTRASEC) VALUES ('ENTERPRISE', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
